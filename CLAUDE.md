...
- `breathing` - Pulsing brightness effect (auto cycling through hue)
- `rainbow` - Rainbow color cycle chase
- `chase:green`, `chase:red`, etc. - Chase loop with specified color
- `solid:green`, `solid:red`, etc. - Solid color fill
